...
class NaoDriver:
    """ NaoDriver : gives access to real ou virtual NAO """
    def __init__(self, nao_ip="localhost", nao_port=11212):
        ...
        self.__vnao_path = "/home/newubu/Robotics/nao/vnao/plugin-v2/imgs"
        self.__vnao_frame = 0 
        ...
        In principle, you do not nee to use it, as function to retrieve images are already given
...
if __name__ == "__main__":
    ...
    nao_drv.set_virtual_camera_path("/home/titouan/PycharmProjects/AsservissementVisuel/VREP/UE52-VS-IK/imgs")
